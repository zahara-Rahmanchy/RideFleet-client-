...
// Fix the length currently cover given
          ...
          requests.map((vehicle, index) => (
            ...
            >
              ...
              <div className="relative bg-[#EAF3FE]  md:col-span-3 col-span-5 py-3 ps-4 pe-5 w-full rounded-md shadow-lg z-10 flex flex-col space-y-2 h-[330px]">
                ...
                <button
                  onClick={() => handleVehicleDetails(vehicle.id)}
                  className="bg-[#4ca5b5] absolute bottom-4 font-medium p-1 text-white btn-md text-sm rounded-md w-1/3 me-4"
                >
                  Details
                </button>
              </div>
              <div className="h-[330px] md:overflow-x-visible overflow-x-clip  lg:bg-[length:auto_500px] bg-cover lg:bg-repeat bg-no-repeat  lg:bg-right-top bg-center  relative flex  flex-col-reverse justify-center items-center md:right-[30%]  md:col-span-2  ">
                {/* TODO: fix bottom here */}
                <svg
                  viewBox="0 0 200 200"
                  xmlns="http://www.w3.org/2000/svg"
                  className="absolute -z-10 md:-left-14 left-9  w-[300px] h-[900px] md:bottom-auto -bottom-[9rem] "
                >
                  <path
                    fill="#F6FC3C"
                    d="M34.2,-51.5C49.2,-43.6,69.6,-42.3,79.2,-32.8C88.7,-23.3,87.4,-5.5,83,10.6C78.7,26.7,71.2,41,59.3,47.3C47.4,53.5,31.1,51.7,15.9,57.9C0.8,64,-13.2,78.1,-27,79.6C-40.8,81.2,-54.4,70.1,-62.3,56.5C-70.2,42.9,-72.2,26.8,-74.6,10.7C-77,-5.4,-79.7,-21.5,-73.8,-33.4C-67.9,-45.2,-53.3,-52.8,-39.6,-61.3C-25.9,-69.7,-12.9,-79.1,-1.7,-76.5C9.6,-73.9,19.2,-59.4,34.2,-51.5Z"
                ...
                <Image
                  ...
                  className="absolute lg:left-0 md:-left-10 md:bottom-auto  left-[2rem] bottom-52 z-20 lg:scale-150 hover:scale-150 "
                />
              </div>
              {/* <VehicleSkeleton /> */}
            </article>
