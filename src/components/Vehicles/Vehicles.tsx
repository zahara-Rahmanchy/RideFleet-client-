      ...
      <section className="grid lg:grid-cols-2 grid-cols-1 lg:ps-0 ps-20  gap-5 col-span-3 my-20  place-items-center place-content-center">
        ...
        {requests ? (
          requests.map((vehicle: any, index: number) => (
            <article className="grid grid-cols-5 pb-9" key={index}>
              <div className="relative bg-[#EAF3FE] lg:col-span-3 md:col-span-2 py-6 ps-4 pe-5 rounded-md shadow-lg z-10 flex flex-col space-y-2 h-[350px]">
