...
const Guideline = () => {
  return (
   ...
   <div className='md:col-span-1 col-span-2 bg-sky-950 bg-opacity-80 flex justify-center items-center'><h3 className='py-10 px-5 ms-10  md:text-7xl text-6xl  font-semibold text-yellow-200 text-wrap'>How Does it Work?</h3></div>
<div className='md:col-span-1 col-span-2 py-10 px-10 bg-sky-950 bg-opacity-80'> <ol className="relative border-l border-gray-200 dark:border-gray-700">                  
        <li className="mb-10 ml-6">            
            ...
            <h3 className="flex items-center mb-1 text-xl font-semibold text-yellow-200 dark:text-white">Browse Our Fleet </h3>
                <p className="mb-4 text-base font-normal text-white dark:text-gray-400">Explore our diverse vehicle options to find the perfect match for your journey.</p>
