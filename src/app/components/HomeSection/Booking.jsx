...
<div className="relative z-0 md:w-4/5 w-full mb-6 group" data-aos="slide-up">
   ...
   */}
      <input type="textarea"  name="floating_phone" id="floating_phone" className="block py-2.5 px-0 w-full text-sm text-blue-700 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"  placeholder=" "  required />
      <label for="floating_phone" className="peer-focus:font-medium absolute text-sm text-blue-400 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-yellow-200 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Message</label>
</div>
  
 
 
  
  <button type="submit" className="text-white bg-yellow-300 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto md:px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send</button>
</form>
</section>
  <section data-aos="fade-up" className='md:col-span-1 col-span-3 md:order-2 order-1 flex flex-col  justify-center p-4'>
    <h2 className='text-4xl text-yellow-200 font-semibold mt-10 text-center'>Contact With Us!</h2>
   <p className='mt-3 text-md text-white text-wrap text-center' data-aos="slide-up">Fiil up the form with your details and Ask your query</p>
