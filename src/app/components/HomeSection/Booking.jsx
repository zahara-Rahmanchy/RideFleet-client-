...
<section className="md:col-span-2 col-span-3 p-20 md:order-1 order-2 " ><form className='md:w-[90%] w-full bg-sky-950 bg-opacity-50 rounded-md p-5' data-aos="fade-up">
