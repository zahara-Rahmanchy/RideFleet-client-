...
<section className='md:col-span-2 col-span-3 p-20 md:order-1 order-2 '><form className='md:w-[90%] w-full bg-sky-950 bg-opacity-50 rounded-md p-5'>
<div className="relative z-0 md:w-4/5 w-full mb-6 group">
  ...
  <button type="submit" className="text-white bg-yellow-300 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Book</button>
</form>
</section>
  <section  className='md:col-span-1 col-span-3 md:order-2 order-1 flex flex-col  justify-center p-4'><h2 className='text-4xl text-yellow-200 font-semibold mt-10'>Making your Booking.</h2>
   <p className='mt-3 text-md text-white text-wrap'>Fiil up the form with your details and get the ride at your doorstep</p>

  <div className='flex flex-row items-center space-x-3'>
  <hr className='w-1/2' /> <p className='text-yellow-200'> OR</p> <hr className='w-1/2'/>
  </div>

  <button className='btn bg-yellow-200 font-medium text-xl p-4 rounded-lg text-sky-900 mt-3 w-4/5 mx-auto'>Call us On: 0132889798</button>
   </section>
