...
const Rates = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto  my-32">
      <h2 className="text-5xl font-semibold text-sky-900 text-center">
        Our Rental Plans
      </h2>
      ...
      <div className="grid lg:grid-cols-3 grid-cols-1 w-full mx-auto place-items-center lg:gap-4 gap-6 ">
        {rates.map(plan => (
          ...
          >
            <h2
              className="text-sky-600 font-semibold text-2xl text-center mb-4 mt-2"
              data-aos="slide-up"
            >
              {plan.name}
            </h2>
              ...
              >
                ...
                >
                  ...
                  <ul className=" list-disc ">
                    <li className="text-gray-200 text-sm font-medium">
                      {vehicle.daily} BDT/
                      <span className="text-sm text-center mt-3  ">Day</span>
                    </li>
                    <li className="text-gray-200 text-sm font-medium">
                      {vehicle.weekly} BDT/
                      <span className="text-sm text-center   mt-3 ">Week</span>
                    </li>
                    <li className="text-gray-200 text-sm font-medium">
                      {vehicle.monthly} BDT/
                      <span className="text-sm text-center  mt-3 ">Month</span>
                    </li>
                  </ul>
                </div>
              </div>
