...
const Banner = () => {
  ...
  return <> <section className="grid md:grid-cols-2  md:gap-4  bg-[#F8F9FD] h-[500px] "style={{backgroundImage: `url(${"/background.jpg"})`}}>
  ...
  <Swiper
      ...
      >
        ...
        <h1 className="md:text-5xl  text-4xl z-10 md:text-sky-950 text-yellow-200 font-bold pb-3 md:ms-6 mt-5 text-wrap"  data-aos="zoom-in">Ready to Hit <br/>the Road?</h1>
        <h2 className="md:text-2xl   text-xl z-10 md:text-yellow-400 text-white  italic font-medium  md:ms-6 text-wrap "  data-aos="zoom-in"> Hire Your Perfect Ride with Us Today!</h2>
        <button className=" md:ms-6   my-4 btn btn-md bg-blue-800 text-white font-medium border-black-700 border-2 w-24 rounded-lg p-2 flex-none" data-aos="zoom-in">Hire Now</button>
