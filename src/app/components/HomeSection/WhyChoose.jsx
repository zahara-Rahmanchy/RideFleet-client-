        ...
        <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5'>
            <div className='shadow-lg bg-gray-100 flex flex-col justify-center p-8'>
                ...
                our diverse range of vehicles has you sorted. From bikes to trucks,
                 we offer affordable options for any occasion.</p>
            </div>
            <div className='shadow-lg bg-gray-100 flex flex-col justify-center p-8'>
                ...
                Our rental options ensure you get the best value for your money without compromising on quality.</p>
            </div>

            <div className='shadow-lg bg-gray-100 flex flex-col justify-center p-8'>
                <h4 className='text-xl font-bold text-center mb-5 text-sky-900'>Ease of Availability</h4>
                <p className='text-md text-gray-900 text-center'> 
                Need a vehicle on short notice? We've got you covered. With a seamless booking process, our vehicles are readily available whenever and wherever you need them.</p>
            </div>
            <div className='shadow-lg bg-gray-100 flex flex-col justify-center p-8'>
                ...
                and thorough inspections to ensure it's road-ready and reliable.</p>
            </div>
        </div>
    </section>
  )
