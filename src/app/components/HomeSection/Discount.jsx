...
const Discount = () => {
  ...
  return (
    <section className="min-h-[400px] my-32">
      <section className="h-full grid grid-cols-2 " style={{backgroundImage: `url(${"/brandon.jpg"})`,
    backgroundRepeat: "no-repeat",
    backgroundSize: "cover",
    backgroundPosition: "center"}}>

        <div className=" md:col-span-1 col-span-2 bg-sky-950 bg-opacity-80 h-[400px] flex flex-col justify-center items-center mt-2 md:mt-0" data-aos="fade-up">
        ...
        <div className="md:col-span-1 col-span-2 bg-sky-950  bg-opacity-80 h-[400px] flex flex-col justify-center items-center" data-aos="slide-up">
