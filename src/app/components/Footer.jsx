        ...
        <div className="md:flex md:justify-between">
          ...
          <div className="mb-6 md:mb-0">
            <a href="https://flowbite.com/" className="flex items-center">
              <span className="self-center text-2xl font-semibold whitespace-nowrap text-yellow-200 dark:text-white flex flex-row">
                Ride
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            {/* Resource links */}
            <div>
              <h2 className="mb-6 text-sm font-semibold text-sky-600 uppercase dark:text-white">
                Resources
              </h2>
